...
async def main():
    ...
    print("Account methods:", [m for m in dir(account) if not m.startswith('_')])
    
    # Also verify connection object again just in case
    connection = account.get_rpc_connection()
    print("Connection methods:", [m for m in dir(connection) if not m.startswith('_')])
