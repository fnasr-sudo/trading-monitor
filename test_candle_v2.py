...
async def test_get_candle():
    ...
    try:
        ...
        # Test get_candle with explicit keyword args
        print("Testing with keyword args...")
        # Note: MetaApi often uses boolean for keepSubscription, but let's see.
        candle = await connection.get_candle(symbol='EURUSD', timeframe='5m', offset=1)
        print(f"Success: {candle}")
